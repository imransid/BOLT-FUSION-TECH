 ...
 *
 *  1. `photo` — null for all ten. No real photographs exist yet, and the rule
 *     is no fake faces, ever: the template line-art that stood here has been
 *     removed, not renamed. Add a real photograph and the card gains its photo
 *     slot; PLAN.md §9 lists "10 real team photos" as an open prerequisite.
 *
